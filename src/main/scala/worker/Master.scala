  ...
  override def receiveCommand: Receive = {
        ...
        workers.get(workerId) match {
          case Some(s @ WorkerState(_, Idle)) =>
            ...
            persist(WorkStarted(work.workId)) { event =>
              workState = workState.updated(event)
              log.info("Cluster Master -> Delegating work to: Worker Id {} | Work Id {} | Device Id {}", workerId, work.workId, work.device.getId)
    ...
    case MasterWorkerProtocol.WorkIsDone(workerId, workId, result) =>
      ...
      if (workState.isDone(workId)) {
        ...
        log.info("Cluster Master -> Acknowledged work done: Work Id {} | Worker Id {}", workId, workerId)
    ...
    case work: Work =>
      ...
      if (workState.isAccepted(work.workId)) {
        ...
        log.info("Cluster Master -> Accepted work: Work Id {} | Device Id {}", work.workId, work.device.getId)
